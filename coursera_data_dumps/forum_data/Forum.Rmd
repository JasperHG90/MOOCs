...
tagRes <- treetag(corp[[1]], treetagger="manual", format="obj",
                      TT.tknz=FALSE , lang="en",
                      TT.options=list(path="/users/jasper/downloads/treeee", preset="en"))
# To data frame
...
However, advanced NLP support is much more developed in Python. I will add a script soon for NLP in Python.
